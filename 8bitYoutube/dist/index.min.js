...
exports.configYoutube = configYoutube;
...
var _requestServices = __webpack_require__(8);
...
async function getCommentsData(url) {
    try {
        ...
        var response = await (0, _requestServices.sendRequest)(parseUrl);
        var commentData = [];
...
var generateCommentsUrl = function generateCommentsUrl(url) {
    return 'https://www.googleapis.com/youtube/v3/commentThreads?key=' + _config.configYoutube.userKey + '&textFormat=plainText&order=relevance&part=snippet&videoId=' + getVideoId(url);
};
...
var _videoController = __webpack_require__(10);

var _commentsController = __webpack_require__(9);
