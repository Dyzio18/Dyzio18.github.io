//(function ({
    ...
    function openLeftNav() {
        closeRightNav();
        document.querySelector("#left_nav").style.width = "230px";
        $( ".main" ).addClass( "main__overlay" );
    }
    function closeLeftNav() {
        document.querySelector("#left_nav").style.width = "0";
        $( ".main" ).removeClass( "main__overlay" );
    }

    function openRightNav() {
        closeLeftNav();
        document.querySelector("#right_nav").style.width = "230px";
        $( ".main" ).addClass( "main__overlay" );
    }

    function closeRightNav() {
        document.querySelector("#right_nav").style.width = "0";
        $( ".main" ).removeClass( "main__overlay" );
    }
